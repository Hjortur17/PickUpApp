    ...
    return (
        <StyledView id='container' className="max-w-screen-lg w-full mx-auto relative">
            ...
            <StyledView className='h-full flex justify-center items-center space-y-3 mt-8'>
                ...
                <StyledLightTitle style={{fontFamily: 'Lato_300Light'}} className='mb-8'>This table is here to assist
                ...
                <StyledButton
                    className='rounded-lg p-5 bg-neutral-50 text-neutral-900 justify-between w-64 flex flex-row justify-between items-center rounded-lg'>
                    <StyledText style={{fontFamily: 'Lato_400Regular'}}
                                className='table-cell align-top'>English</StyledText>
