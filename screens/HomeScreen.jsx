...
const StyledLightTitle = styled(Text, 'font-light text-2xl text-neutral-900');
    ...
    return (
        <StyledView id='container' className="max-w-screen-md w-full mx-auto relative">
            ...
            <StyledView className='h-full flex justify-center items-center space-y-3 mt-8'>
                <StyledBoldTitle style={{fontFamily: 'LibreFranklin_800ExtraBold'}}>Welcome to Geysir Car
                    Rental</StyledBoldTitle>
                <StyledLightTitle style={{fontFamily: 'Lato_300Light'}} className='mb-8'>This table is here to
                    assist
                    you through the self checkout process</StyledLightTitle>
                <StyledSubtitle style={{fontFamily: 'LibreFranklin_600SemiBold'}} className='mb-4'>Start by choosing
                    your language</StyledSubtitle>
                ...
                <StyledButton
                    ...
                    onPress={() => navigation.navigate('EnglishLanding')}
                >
                    <StyledText style={{fontFamily: 'Lato_400Regular'}}>English</StyledText>
                ...
                <StyledButton
                    className='rounded-lg p-5 bg-neutral-100 bg-opacity-50 text-neutral-900 justify-between w-64 flex flex-row justify-between items-center rounded-lg'
                    onPress={() => navigation.navigate('FrenchLanding')}>
                    <StyledText style={{fontFamily: 'Lato_400Regular'}}
                                className='table-cell align-top'>Français</StyledText>

                    <StyledView className="w-8 h-8 rounded">
                ...
                <StyledButton
                    className='rounded-lg p-5 bg-neutral-100 bg-opacity-50 text-neutral-900 justify-between w-64 flex flex-row justify-between items-center rounded-lg'
                    onPress={() => navigation.navigate('GermanLanding')}>
                    <StyledText style={{fontFamily: 'Lato_400Regular'}}
                                className='table-cell align-top'>Deutsche</StyledText>

                    <StyledView className="w-8 h-8">
                        <Svg xmlns="http://www.w3.org/2000/svg" id="flag-icons-de" viewBox="0 0 640 480">
                            <Path fill="#000" d="M0 020h640v160H0z"/>
