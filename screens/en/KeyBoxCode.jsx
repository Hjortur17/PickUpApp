...
export default function EnglishKeyBoxCode({navigation}) {
    ...
    return (
        <StyledView id='container' className="max-w-screen-lg w-full mx-auto relative">
            ...
            <StyledView className='h-full flex justify-center items-center space-y-3 max-w-screen-md mx-auto'>
                <StyledBoldTitle style={{fontFamily: 'LibreFranklin_800ExtraBold'}} className='text-left'>Where do I find my key box
                    code?</StyledBoldTitle>
